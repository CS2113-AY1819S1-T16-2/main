 ...
 * outside of the SelectEventCommand code. For example, inputs "1" and "1 abc" take the
 * same path through the SelectEventCommand, and therefore we test only one of them.
