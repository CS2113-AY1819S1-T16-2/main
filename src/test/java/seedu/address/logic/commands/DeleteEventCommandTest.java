...
public class DeleteEventCommandTest {
    ...
    @Test
    public void equals() {
        DeleteEventCommand cancelFirstCommand = new DeleteEventCommand(INDEX_FIRST_EVENT);
        DeleteEventCommand cancelSecondCommand = new DeleteEventCommand(INDEX_SECOND_EVENT);

        // same object -> returns true
        assertTrue(cancelFirstCommand.equals(cancelFirstCommand));

        // same values -> returns true
        DeleteEventCommand cancelFirstCommandCopy = new DeleteEventCommand(INDEX_FIRST_EVENT);
